...
async function main() {
  ...
  const subscribers = [
    ...
    { email: "kwame.asante@gmail.com", consent: true, source: "newsletter_home" },
    { email: "fatima.mohammed@talaat.org", consent: true, source: "capital_page" },
    { email: "chidi.nwosu@hyperion.io", consent: false, source: "rsvp_investor_event" },
    { email: "nala.sereti@originlabs.co.ke", consent: true, source: "capital_page" },
    { email: "samuel.bekele@addisfund.et", consent: true, source: "newsletter_home" },
    { email: "zainab.ibrahim@kanoventures.ng", consent: true, source: "approach_page" },
    { email: "david.mwangi@nairobitech.co.ke", consent: false, source: "rsvp_demo_day" },
    { email: "aisha.toure@bamakocapital.ml", consent: true, source: "capital_page" },
    { email: "emmanuel.osei@accrafund.gh", consent: true, source: "newsletter_home" },
  ];
  ...
  const programApplications = [
    { programSlug: "quest-fellowship", firstName: "Selam", lastName: "Tadesse", email: "selam@greenquest.et", phone: "+251 91 234 5678", linkedinUrl: "https://linkedin.com/in/selamtadesse", location: "Addis Ababa, Ethiopia", currentRole: "Sustainability Consultant", companyName: "GreenQuest Ethiopia", motivation: "Building a carbon credit marketplace for Ethiopian smallholder farmers. The Quest Fellowship's Disciplined Entrepreneurship framework is exactly what I need to move from idea to product-market fit.", referral: "University network", status: "pending" },
    { programSlug: "xcelerator", firstName: "Obi", lastName: "Eze", email: "obi@paystacklite.ng", phone: "+234 803 456 7890", linkedinUrl: "https://linkedin.com/in/obieze", location: "Lagos, Nigeria", currentRole: "CTO", companyName: "PayStack Lite", motivation: "Simplified payment infrastructure for informal merchants. Already processing $200K/month. Need the Xcelerator's network and capital connections to scale across the Route.", referral: "Y Combinator alumni", status: "reviewing" },
    { programSlug: "venture-studio", firstName: "Amina", lastName: "Hassan", email: "amina@studio404.co.ke", phone: "+254 712 345 678", linkedinUrl: "https://linkedin.com/in/aminahassan", location: "Nairobi, Kenya", currentRole: "Product Lead", companyName: "Safaricom", motivation: "6 years building M-Pesa products. Have 3 venture ideas in insurtech and agritech that need the Venture Studio's co-building model to launch properly.", referral: "Safaricom internal", status: "pending" },
    { programSlug: "lab-residency", firstName: "Dawit", lastName: "Mekonnen", email: "dawit@biorift.et", phone: "+251 91 567 8901", linkedinUrl: "https://linkedin.com/in/dawitmekonnen", location: "Addis Ababa, Ethiopia", currentRole: "Research Scientist", companyName: "Ethiopian Biotechnology Institute", motivation: "Developing CRISPR-based diagnostic tools for livestock diseases. Need lab space, equipment access, and commercialization support that the Lab Residency provides.", referral: "Academic network", status: "contacted" },
    { programSlug: "quest-fellowship", firstName: "Grace", lastName: "Muthoni", email: "grace@farmconnect.co.ke", phone: "+254 722 345 678", linkedinUrl: "https://linkedin.com/in/gracemuthoni", location: "Nakuru, Kenya", currentRole: "Founder", companyName: "FarmConnect Kenya", motivation: "B2B marketplace connecting smallholder farmers to institutional buyers. 500 farmers on platform, $80K GMV. Quest Fellowship will help me professionalize operations and build the right team.", referral: "xCellero website", status: "pending" },
    { programSlug: "xcelerator", firstName: "Rashid", lastName: "Sow", email: "rashid@energysolutions.sn", phone: "+221 77 567 8901", linkedinUrl: "https://linkedin.com/in/rashidsow", location: "Dakar, Senegal", currentRole: "CEO", companyName: "Energy Solutions Sénégal", motivation: "Solar-as-a-service for commercial buildings in Dakar. 15 installations completed, $300K ARR. Xcelerator will help us build the operational systems to scale to 100+ installations.", referral: "Terre Ventures", status: "reviewing" },
    { programSlug: "venture-studio", firstName: "Bongi", lastName: "Nkosi", email: "bongi@towntech.co.za", phone: "+27 82 345 6789", linkedinUrl: "https://linkedin.com/in/bonginkosi", location: "Cape Town, South Africa", currentRole: "Head of Product", companyName: "Takealot", motivation: "Ex-entrepreneur with 1 exit. Have identified a gap in township logistics that needs the Venture Studio's co-building approach to execute while I maintain my day job.", referral: "Takealot alumni", status: "pending" },
    { programSlug: "lab-residency", firstName: "Mariam", lastName: "Traore", email: "mariam@biotech.ml", phone: "+223 70 567 8901", linkedinUrl: "https://linkedin.com/in/mariamtraore", location: "Bamako, Mali", currentRole: "PhD Researcher", companyName: "University of Bamako", motivation: "Researching low-cost water purification using locally sourced materials. Lab Residency would give me access to proper facilities and mentorship to turn my research into a viable product.", referral: "University supervisor", status: "accepted" },
    { programSlug: "quest-fellowship", firstName: "Kwesi", lastName: "Boateng", email: "kwesi@agrisolutions.gh", phone: "+233 24 567 8901", linkedinUrl: "https://linkedin.com/in/kwesiboateng", location: "Kumasi, Ghana", currentRole: "Agricultural Engineer", companyName: "AgriSolutions Ghana", motivation: "Precision irrigation system using IoT sensors and mobile money payments. Early prototype working on 3 farms. Quest Fellowship will help me validate the business model and build the right go-to-market.", referral: "KNUST network", status: "pending" },
    { programSlug: "xcelerator", firstName: "Fikre", lastName: "Mulugeta", email: "fikre@logix.et", phone: "+251 91 890 1234", linkedinUrl: "https://linkedin.com/in/fikremulugeta", location: "Addis Ababa, Ethiopia", currentRole: "Founder & CEO", companyName: "LogiX Ethiopia", motivation: "Last-mile logistics platform for Ethiopian e-commerce. Processing 500 deliveries/day in Addis. Need the Xcelerator to build the tech infrastructure and partnerships for national expansion.", referral: "ICE Addis", status: "declined" },
  ];
